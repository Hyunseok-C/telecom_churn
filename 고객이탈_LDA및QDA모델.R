...
# CV 성능 확인
fit_lda$resample
lda_cv_acc <- mean(fit_lda$resample$Accuracy); lda_cv_acc # 0.8499575
lda_cv_kap <- mean(fit_lda$resample$Kappa); lda_cv_kap    # 0.2439226
...
# CV 성능 확인
fit_qda$resample
qda_cv_acc <- mean(fit_qda$resample$Accuracy); qda_cv_acc # 0.8597
qda_cv_kap <- mean(fit_qda$resample$Kappa); qda_cv_kap    # 0.4202
